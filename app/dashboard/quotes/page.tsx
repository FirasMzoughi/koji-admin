  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 font-outfit">Quotes</h1>
          <p className="text-gray-500 mt-2">Track and manage all client proposals.</p>
        </div>
          ...
          <table className="w-full text-left text-sm whitespace-nowrap">
            <thead className="bg-gray-50/50 border-b border-gray-100">
              <tr>
                ...
                <th className="px-6 py-4 font-semibold text-gray-900">Date Signed</th>
